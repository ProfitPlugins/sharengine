...
*/
include_once "seHighchartOption.php";
include_once "seHighchartOptionRenderer.php";

class seHighchart implements ArrayAccess
{
    //The chart type.
    //A regullar higchart
    const HIGHCHART = 0;
    ...
    {
        return seHighchartOptionRenderer::render($this->_options);
    }
    ...
    {
        $this->_options[$offset] = new seHighchartOption($value);
    }
    ...
    public function offsetGet($offset)
    {
        if (!isset($this->_options[$offset])) {
            $this->_options[$offset] = new seHighchartOption();
        }
