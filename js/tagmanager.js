                    ...
                    if (!ignoreEvents)
                        if (opts.AjaxPush !== null && opts.AjaxPushAllTags == null) {
                            if ($.inArray(tag, opts.prefilled) === -1) {
                                $.post(opts.AjaxPush, $.extend({tag: tag}, opts.AjaxPushParameters), function(response){
            ...
            pushAllTags : function (e, tag) {
                ...
                if (opts.AjaxPushAllTags) {
                    if (e.type !== 'tm:pushed' || $.inArray(tag, opts.prefilled) === -1) {
                        ...
                        if (typeof  opts.BeforeAjaxCallback == 'function')
                        {
                            opts.BeforeAjaxCallback.call(this);
                        }

                        $.post(opts.AjaxPush, $.extend({ tags: tlis.join(opts.baseDelimiter) }, opts.AjaxPushParameters), function(response){

                            if (typeof opts.AjaxCallback.call == 'function')
                            {
                                opts.AjaxCallback.call(this, response);
                            }
