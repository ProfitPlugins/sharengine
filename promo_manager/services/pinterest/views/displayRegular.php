<div rel="se_enable_user_field_1">
    ...
    <div class="separator">
        ...
        <div class="settings-content">
            ...
            <textarea name="to_insert[pinterest][description]" class="message" maxlength="118" size="140"></textarea>
            <p class="counter"></p>
        </div>
    </div>
    ...
    <div class="separator">
        ...
        <div class="settings-content">
            ...
            <input type="text" class="acera-fullwidth upload_image" id="se_tweet" name="to_insert[pinterest][image_url]" placeholder="URL">
    ...
    <div class="separator">
        ...
        <div class="settings-content">
            ...
            <input type="text" class="acera-fullwidth " id="se_tweet" name="to_update[pinterest][url]" placeholder="URL" value="">
