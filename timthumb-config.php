...
// this is the standard set up with wp-content
$file_path = dirname(__FILE__);

define ('WP_CONTENT_DIR', realpath($file_path.'/../../'));
...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', WP_CONTENT_DIR.'/uploads/cache');
...
if(! defined('FILE_CACHE_ENABLED') && is_dir(FILE_CACHE_DIRECTORY) )
{
